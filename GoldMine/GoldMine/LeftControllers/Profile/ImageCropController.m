...
@property (nonatomic, strong) SoapRequest *headImageRequest;
...
- (void)clickSave:(id)sender
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(imageCrop:didFinished:)]) {
...
- (void)initView
{
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - NAVI_HEIGHT)];
