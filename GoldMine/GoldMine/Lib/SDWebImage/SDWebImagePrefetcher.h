...
@end
typedef void(^SDWebImagePrefetcherProgressBlock)(UIImage *image, NSError *error, SDImageCacheType cacheType);
typedef void(^SDWebImagePrefetcherCompletionBlock)(UIImage *image, NSError *error, SDImageCacheType cacheType, BOOL finished);
